...
public class RotateLoading extends View {
    ...
    public interface IRotateLodingListenner {
        void onStop();
    }

    private IRotateLodingListenner rotateLodingListenner;

    public void setRotateLodingListenner(IRotateLodingListenner rotateLodingListenner) {
        this.rotateLodingListenner = rotateLodingListenner;
    }
